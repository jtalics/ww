...
{    
    ...
    private boolean m_firstOnChange; //jquery slider fires 2 change events for programmatic setting of values on the range slider (2 anchors)
    ...
    {
        /* 
         * Note: m_firstOnChange is used because the jquery slider will fire
         * a change event per anchor even though all the anchors' values are set
         * by the first change event.  
         * 
         * This happens only when values are changed programmatically.  
         * 
    ...
    {
        /*
         * The duplicate firing of events only happens if values were set programmatically,
         * so check hasOriginalEvent
         */
        if (hasOriginalEvent || m_firstOnChange) {
            int[] vals = jsArrayIntegerToIntArray(values);        
    ...
    private native void createSliderJS(Slider x, String id, JavaScriptObject options) /*-{
        options.start = function(event, ui) {
            x.@com.jtalics.ww.client.widgets.slider.Slider::fireOnStartEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
        options.slide = function(event, ui) {
            return x.@com.jtalics.ww.client.widgets.slider.Slider::fireOnSlideEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
        options.change = function(event, ui) {
            var has = event.originalEvent ? true : false;
            x.@com.jtalics.ww.client.widgets.slider.Slider::fireOnChangeEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;Z)(event, ui.values, has);                
        };
        options.stop = function(event, ui) {
            x.@com.jtalics.ww.client.widgets.slider.Slider::fireOnStopEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayInteger;)(event, ui.values);
        };
